        ...
        <form id="qdbform" name="qdbform" method="POST"  encType='multipart/form-data' action="./process.php">
            ...
            <div id="part-a">
                <dl>
                    ...
                    <dd class=m><input type=text size=40 name=_fid_8 ></dt>

                    <dt class=m>Ship Address</dt>
                    <dd class=m><input type=text size=60 name=_fid_9 ></dd>

                    <dt class=m>Street 1</dt>
                    <dd class=m><input type=text size=60 name=_fid_10 ></dd>

                    <dt class=m>Street 2</dt>
                    <dd class=m><input type=text size=60 name=_fid_11 ></dd>

                    <dt class=m>City</dt>
                    <dd class=m><input type=text size=60 name=_fid_12 ></dd>
                    ...
                    <dd class=m><input type=text size=60 name=_fid_14 ></dd>

                    <dt class=m>Country</dt>
                    <dd class=m><input type=text size=60 name=_fid_15 ></dd>

                    <dt class=m>Contact</dt>
                    <dd class=m><input type=text size=40 name=_fid_16 ></dd>

                    <dt class=m>Phone</dt>
                    <dd class=m><input type=text size=40 name=_fid_17 ></dd>

                    <dt class=m>Purpose of Sample Size</dt>
                    <dd class=m><textarea  name=_fid_18 rows=6 cols=60></textarea></dd>
                </dl>
            </div>
            <div id="part-b">
                <input type=hidden name=fform value=1>
